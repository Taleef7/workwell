...
| Second opinion | **`cqf-fhir-cr`** (HAPI, Java) over the same artifacts | **299/323 agree across seven measures**, three of them 100% and the multi-rate CMS137 at 44/45 on both rates — the first execution of our artifacts by an engine that is not ours. **21 of the 24 disagreements now trace to one function** across three measures — the two engines read a medication order's period differently (`CumulativeMedicationDuration.medicationRequestPeriod`). Two CMS125 cases remain unexplained; CMS137's one is a separate, diagnosed period boundary |
...
The approved active plan is [`docs/ROADMAP_2026-08-30.md`](docs/ROADMAP_2026-08-30.md) (the Maui pilot — ADR-070); the verification bar remains the FHIR-column set in [`docs/ROADMAP_2026-08-04.md`](docs/ROADMAP_2026-08-04.md) §4; the ADR run 036–070 is in [`docs/DECISIONS.md`](docs/DECISIONS.md) and the running narrative in [`docs/JOURNAL.md`](docs/JOURNAL.md) (newest first).

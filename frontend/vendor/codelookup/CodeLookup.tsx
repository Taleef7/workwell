...
import { cn } from '@mieweb/ui/utils'; // VENDORED EDIT: was '../../utils/cn'
import { Card, CardContent } from '@mieweb/ui'; // VENDORED EDIT: was '../Card/Card'
import {
  SearchIcon,
  LoaderIcon,
  AlertCircleIcon,
  ChevronRightIcon,
  ChevronLeftIcon,
} from './icons'; // VENDORED EDIT: was '../Icons' (lucide re-export shim)

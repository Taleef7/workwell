      ...
      <section className="relative hidden flex-col justify-between gap-10 p-10 text-white lg:flex lg:w-[52%] xl:p-14">
        ...
        <div className="max-w-md space-y-5">
          ...
          <p className="text-base leading-7 text-slate-400">
            {SUBJECT.domain}, deterministic CQL evaluation, and a complete audit trail — one reviewable workspace.
          </p>
        ...
        <div className="w-full max-w-[400px] pt-16 lg:pt-0">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={pending}
              className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-primary-600 text-sm font-semibold text-white transition hover:bg-primary-700 disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2"
            >
              {pending ? (
                <>

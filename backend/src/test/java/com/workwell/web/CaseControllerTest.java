...
class CaseControllerTest {
    ...
    void listsCases() throws Exception {
        ...
        when(caseFlowService.listCases("open", null, null, null, null, null, null, null, 25, 0)).thenReturn(List.of(
    ...
    void listsExcludedCases() throws Exception {
        ...
        when(caseFlowService.listCases("excluded", null, null, null, null, null, null, null, 25, 0)).thenReturn(List.of(
                new CaseFlowService.CaseSummary(
                        caseId,
                        "patient-010",
                        "patient-010",
    ...
    void rejectsUnsupportedCaseStatus() throws Exception {
        when(caseFlowService.listCases("bogus", null, null, null, null, null, null, null, 25, 0))

...
export const CMS122V14: OfficialMeasureReference = {
  ...
  criteria: [
    ...
    },
    {
      ...
      description: "A qualifying encounter during the measurement period (office visit, annual wellness, preventive care 18+, home health, nutrition services, or telephone visit), plus direct-reference medical-nutrition-therapy codes (CPT 97802/97803/97804, HCPCS G0270/G0271).",
      valueSetOids: [
    ...
    },
    {
      ...
      description: "Patients 66+ by end of the measurement period living long-term in a nursing home — defined by a 'Housing status' assessment (LOINC 71802-3) whose result is 'Lives in nursing home (finding)' (SNOMED CT 160734000). v14 uses these direct-reference codes, not a 'Nursing Facility Visit' value set.",
      valueSetOids: [],
      coverage: "OMITTED",

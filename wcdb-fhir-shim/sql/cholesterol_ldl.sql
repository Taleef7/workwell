...
-- Source: rule params for 'cholesterol_ldl' (windowed-recency: windowDays=365, dueSoonDays=30, gracePeriodDays=0)
--         + crosswalk LOINC codes [13457-7, 18262-6, 2089-1] (engine/ingress/webchart/terminology.ts)
...
LEFT JOIN (
  ...
  WHERE oc.loinc_num IN ('13457-7','18262-6','2089-1')

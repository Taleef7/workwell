...
-- Source: rule params for 'obesity_bmi' (windowed-recency: windowDays=365, dueSoonDays=30, gracePeriodDays=0)
--         + crosswalk LOINC codes [39156-5] (engine/ingress/webchart/terminology.ts)

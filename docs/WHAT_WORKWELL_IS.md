...
- **Runs CMS's own published logic:** Many quality systems rewrite official electronic clinical quality measures (eCQMs) into proprietary rules, risking logic discrepancies. WorkWell can execute the Centers for Medicare & Medicaid Services (CMS) published measure files directly. Today the pilot sandbox executes **six** CMS measures that way — CMS122, CMS125, CMS2, CMS130, CMS165 and CMS137 — and the TWH deployment executes two, CMS122 and CMS125. Nine vendored CMS measures pass the measure authors' own published test cases, 455 of 455.

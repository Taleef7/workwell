...
>
> **`·archived`** (14 of 82) means the BODY moved to `docs/archive/DECISIONS_ARCHIVE.md` — superseded,
> or a historical *finding* rather than a decision that governs. `DECISIONS.md` keeps every heading plus
> a pointer, so every cross-reference still resolves. The 68 unmarked titles are the record that governs.
>

...
| Pilot compliance rates, corrected 2026-09-10 (ADR-079) | CMS2 60.9→68.7% · CMS130 19.5→43.3% · CMS165 20.5→62.3% · CMS125 18.0→72.1% · CMS122 7.4→72.4% (inverse) · CMS137 0.4→13.5% | Not a data change: out-of-population patients were in the rate's denominator. `missingData` equalled `total − initialPopulation` exactly for all six measures, so the whole Missing Data column was out-of-population |

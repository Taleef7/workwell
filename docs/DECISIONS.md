...
> **superseded** (7) or that turned out to be a **historical finding written in ADR form** (13) now lives in
...
> the artifact referenced in `docs/JOURNAL.md` (2026-08-05).
>
...
**Historical finding — full text in [`docs/archive/DECISIONS_ARCHIVE.md`](archive/DECISIONS_ARCHIVE.md#adr-057).** Diagnosis + fix for the live WebChart path, with the reasoning that reading a server's own 'female' as not-female is also an inference.
...
**Historical finding — full text in [`docs/archive/DECISIONS_ARCHIVE.md`](archive/DECISIONS_ARCHIVE.md#adr-053).** Diagnosis: CMS138's failure was an ABSENT value set, not a truncated one — the completeness check could not see absence.
...
**Historical finding — full text in [`docs/archive/DECISIONS_ARCHIVE.md`](archive/DECISIONS_ARCHIVE.md#adr-045).** Mechanism: the official-measures flip lives in the deploy workflow, so it is a reviewed, revertable change.
...
**Historical finding — full text in [`docs/archive/DECISIONS_ARCHIVE.md`](archive/DECISIONS_ARCHIVE.md#adr-044).** Diagnosis: a mammogram had to be emitted in both vocabularies, because each single representation fails in the opposite direction.
...
**Historical finding — full text in [`docs/archive/DECISIONS_ARCHIVE.md`](archive/DECISIONS_ARCHIVE.md#adr-042).** Diagnosis: zero of 56 WebChart patients carried `us-core-sex`, so the official measure saw an empty population.

## ADR-041: A capped official expansion is completed at vendor time, from a pinned VSAC release, or not at all

**Historical finding — full text in [`docs/archive/DECISIONS_ARCHIVE.md`](archive/DECISIONS_ARCHIVE.md#adr-041).** Mechanism: completing an upstream-capped value set at vendor time from a pinned VSAC release, or leaving it capped.

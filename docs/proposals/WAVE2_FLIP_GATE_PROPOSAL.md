...
| `catalogId` | `string`, the catalog id (`cms2` or `cms951v4`) | `backend-ts/src/measure/measure-catalog.ts`; add an explicit static mapping to `officialId` to close the current bare-id/versioned-id mismatch. |

...
**Latest (2026-06-26): the post-demo WebChart-convergence roadmap (board #7) is well underway — E10 + ALL of E11 (incl. E11.3 PR-2, the Configure Groups UI) are merged + deployed. E11 is fully closed.** The June-15 demo produced a roadmap of epics E10–E15 (#182–#187, label `webchart-convergence`). Shipped + deployed since:
